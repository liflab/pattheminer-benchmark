...
public class SetupTrendDistanceExperiments extends SetupTrendExperiments<StaticTrendDistanceExperiment>
{
  ...
  {
    super(lab, new StaticTrendDistanceFactory(lab, lab.useFiles()), "Static trend distance throughput", "Measures the throughput of the static trend distance pattern using various window widths and trend processors.", "static trend distance", "std");
  }
}
