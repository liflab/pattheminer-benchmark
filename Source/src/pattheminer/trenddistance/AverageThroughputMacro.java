...
public class AverageThroughputMacro extends NumberMacro
{
  ...
  public Double getNumber()
  {
    ...
    {
      float x = te.get(StaticTrendDistanceStreamExperiment.LENGTH).numberValue().floatValue();
      float y = te.get(StaticTrendDistanceStreamExperiment.TIME).numberValue().floatValue();
      if (x > max_x)
      {
        max_x = x;
        max_y = y;
