...
public class SymbolDistributionClusters extends GroupProcessor
{
  public SymbolDistributionClusters()
  {
    super(1, 1);
    ...
    associateInput(INPUT, slicer, INPUT);
    associateOutput(OUTPUT, to_normalized_vector, OUTPUT);
    addProcessors(slicer, to_normalized_vector);
  }
}
