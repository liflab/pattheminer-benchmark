...
import pattheminer.rscript.SetupBeepBeepVsRscript;
...
import pattheminer.trenddistance.statictd.SetupRealWorldExperiments;
...
public class MainLab extends Laboratory
{
  ...
  /**
   * Whether to include experiments that call R as an external program
   */
  protected boolean m_includeRscriptExperiments = false;
  
  /**
   * Whether to include an experiment that uses a "real world"
   * trace
   */
  protected boolean m_includeRealWorldExperiments = false;
  ...
  {	  
    ...
    if (args != null)
    {
      m_includeRscriptExperiments = args.hasOption("with-r");
    ...
    if (m_includeTrendExperiments)
    {
      ...
      // BeepBeep vs. R
      if (m_includeRscriptExperiments)
      {
        new SetupBeepBeepVsRscript(this).fillWithExperiments();
      }
      
      // Synthetic vs real-world
      if (m_includeRealWorldExperiments)
      {
        new SetupRealWorldExperiments(this).fillWithExperiments();
      }
    }
  ...
  {
    parser.addArgument(new Argument().withLongName("with-r").withDescription("Include experiments that involve R"));
  ...
  /**
   * Determines whether experiments should use static files or input traces
   * generated on-the-fly
   * @return <tt>true</tt> to use static files, <tt>false</tt> otherwise
   */
  public boolean useFiles()
  {
    return m_includeRscriptExperiments;
  }
  ...
  public String isEnvironmentOk()
  {
    if (m_includeRscriptExperiments)
    {
      ...
      CommandRunner runner = new CommandRunner(new String[] {"R", "--version"});
      runner.run();
      String s = runner.getString();
      if (s == null || s.contains("not found"))
      {
        return "R does not seem to be installed on the system";
      }
    }
    return null;
  }
